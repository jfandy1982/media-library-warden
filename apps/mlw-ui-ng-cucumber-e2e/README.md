# mlw-ui-ng-cucumber-e2e (Cucumber BDD E2E Tests)

Behavior-driven development (BDD) end-to-end tests for the `mlw-ui-ng` Angular frontend using Cucumber and Cypress.
...
**Cucumber vs. Cypress:** This app uses **Cucumber with Cypress** underneath. You get the best of both worlds:
...
- **CI mode:** requires a prior build: `nx build mlw-ui-ng --configuration=coverage`
...
nx e2e mlw-ui-ng-cucumber-e2e --spec=src/e2e/smoke/smoke.feature
```
...
nx e2e-ci mlw-ui-ng-cucumber-e2e --configuration=e2e-cucumber-coverage
```

## Test Structure

```
apps/mlw-ui-ng-cucumber-e2e/
├── src/
│   ├── e2e/
│   │   └── smoke/
...
```typescript
Given(
  'the following media items exist:',
  (
    dataTable,
  ) => {
    dataTable
...
**When to Use Cypress (`mlw-ui-ng-cypress-e2e`):**
...
TAGS="@smoke" nx e2e mlw-ui-ng-cucumber-e2e
```
...
# Artifacts saved to:
# - cypress/mlw-ui-ng-cucumber-e2e/screenshots/
# - cypress/mlw-ui-ng-cucumber-e2e/videos/  (video: false by default)
```

## Related Documentation

- **Overview:** See root [README.md](../../README.md) for quick start and environment variables
- **UI Application:** See [apps/mlw-ui-ng/README.md](../mlw-ui-ng/README.md) for Angular UI details
- **Cypress E2E:** See [apps/mlw-ui-ng-cypress-e2e/README.md](../mlw-ui-ng-cypress-e2e/README.md) for Cypress approach
