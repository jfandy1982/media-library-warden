# Media Library Warden

<!-- Badges -->

<!-- Build & Quality -->

[![CI](https://github.com/jfandy1982/media-library-warden/actions/workflows/seed.yml/badge.svg)](https://github.com/jfandy1982/media-library-warden/actions/workflows/seed.yml) [![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=jfandy1982_media-library-warden&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=jfandy1982_media-library-warden) [![Coverage](https://codecov.io/gh/jfandy1982/media-library-warden/branch/main/graph/badge.svg)](https://codecov.io/gh/jfandy1982/media-library-warden)

<!-- Security & Maintenance -->

[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=jfandy1982_media-library-warden&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=jfandy1982_media-library-warden) [![Renovate](https://img.shields.io/badge/renovate-enabled-brightgreen.svg)](https://renovatebot.com/) [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

<!-- Tech Stack -->

[![Node.js](https://img.shields.io/badge/node-24.14.0-brightgreen.svg)](https://nodejs.org/) [![npm](https://img.shields.io/badge/npm-11.9.0-blue.svg)](https://www.npmjs.com/) [![Nx](https://img.shields.io/badge/Nx-22.5-orange.svg)](https://nx.dev/) [![Angular](https://img.shields.io/badge/Angular-21.1-red.svg)](https://angular.io/) [![NestJS](https://img.shields.io/badge/NestJS-11-ea2845.svg)](https://nestjs.com/)
...
- 📱 **[apps/mlw-api/README.md](apps/mlw-api/README.md)** - NestJS backend documentation
- 🖥️ **[apps/mlw-ui-ng/README.md](apps/mlw-ui-ng/README.md)** - Angular frontend documentation

**For Testing:**

- 🧪 **[apps/mlw-api-e2e/README.md](apps/mlw-api-e2e/README.md)** - API E2E tests (Jest)
- 🧪 **[apps/mlw-ui-ng-cypress-e2e/README.md](apps/mlw-ui-ng-cypress-e2e/README.md)** - UI E2E tests (Cypress)
- 🧪 **[apps/mlw-ui-ng-cucumber-e2e/README.md](apps/mlw-ui-ng-cucumber-e2e/README.md)** - UI BDD tests (Cucumber)
...
| `NEST_DEBUG` | NestJS API | Enable NestJS debug logging (`true` or empty) |
...
```bash
npx create-nx-workspace@latest --interactive --skipGit --aiAgents=copilot --preset=apps --name=media-library-warden
```
